    ...
    <main className="max-w-7xl mx-auto p-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-slate-200 dark:bg-slate-800 p-6 rounded-2xl shadow-md mb-10">
        ...
        <input
          ...
          className="w-full md:w-96 p-3 rounded-lg shadow bg-white dark:bg-slate-700 dark:text-white"
        />

        <select className="w-full md:w-60 p-3 rounded-lg shadow bg-white dark:bg-slate-700 dark:text-white">
