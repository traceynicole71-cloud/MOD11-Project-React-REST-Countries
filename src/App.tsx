...
>        <div className="flex flex-col items-center text-center gap-6">
         ...
         <div className="space-y-5 max-w-md">
           <h1 className="text-4xl font-bold bg-red-500 text-white tracking-wide px-8 py-4 rounded-2xl shadow-md hover:scale-105 transition-transform duration-300 cursor-pointer inline-block">
           Get started
            </h1>
